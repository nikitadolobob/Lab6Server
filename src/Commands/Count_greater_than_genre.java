...
public class Count_greater_than_genre extends Command {
    MovieGenre genre;

    public Count_greater_than_genre(MovieGenre genre){
        this.genre = genre;
    }
    ...
    public String runCommand(ArrayList<Movie> arrayList){
        ...
        return "There are " + counter + " elements with genre greater than suggested";
    }
}
